        ...
        for sentence in self.knowledge:
            for sentence2 in self.knowledge:
                if sentence != sentence2:
                    if sentence.cells.issuperset(sentence2.cells):
                        new_sentence = Sentence(sentence.cells.difference(sentence2.cells),sentence.count - sentence2.count)
                        add = True
                        for sentence3 in self.knowledge:
                            if new_sentence == sentence3:
                                add = False
                        if add:
                            self.knowledge.append(new_sentence)
        #raise NotImplementedError
